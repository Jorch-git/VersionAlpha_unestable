...
test('idw', function (t) {
  ...
  var idw1 = idw(testPoints,'value' , 0.5, 0.5, 'kilometers');
  var idw2 = idw(testPoints,'value', 0.65 , 0.65, 'kilometers');
  var idw3 = idw(testPoints,'value', 2 , 1, 'miles');
  var idw4 = idw(testPoints, 'WRONGDataField', 0.3, 0.3, 'miles');
