  ...
  if (filtered.features.length === 0) {
    ...
    for (var i = 0; i < N; i++) {
      ...
      controlPoints.features.map(function (point) {
        ...
        //console.log(centroid(samplingGrid.features[i]), point, units);
        if (d === 0) {
      ...
      //samplingGrid.features[i].properties.strokeColor = 'blue';
      //samplingGrid.features[i].properties.strokeColor = 'white';
      //samplingGrid.features[i].properties.strokeWeight = 0;
      //console.log(samplingGrid.features[i].properties.z = zw / sw);
    }
    return samplingGrid;
