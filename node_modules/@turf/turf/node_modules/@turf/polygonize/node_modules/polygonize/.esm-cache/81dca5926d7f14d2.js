...
var _EdgeRing = require('./EdgeRing');

var _EdgeRing2 = _interopRequireDefault(_EdgeRing);
...
var Graph = function () {
  _createClass(Graph, [{
    ...
    value: function getNode(coordinates) {
      var id = _Node2.default.buildId(coordinates);
      var node = this.nodes[id];
      if (!node) node = this.nodes[id] = new _Node2.default(coordinates);
    ...
    value: function addEdge(from, to) {
      var edge = new _Edge2.default(from, to),
    ...
    value: function fromGeoJson(geoJson) {
      ...
      (0, _meta.flattenEach)(geoJson, function (feature) {
        (0, _invariant.featureOf)(feature, 'LineString', 'Graph::fromGeoJson');
        // When a LineString if formed by many segments, split them
        (0, _meta.coordReduce)(feature, function (prev, cur) {
          if (prev) {
  ...
  _createClass(Graph, [{
    ...
    value: function _findEdgeRing(startEdge) {
      var edge = startEdge;
      var edgeRing = new _EdgeRing2.default();
