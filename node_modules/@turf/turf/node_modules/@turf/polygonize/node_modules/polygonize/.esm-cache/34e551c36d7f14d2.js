...
var _inside2 = require('@turf/inside');

var _inside3 = _interopRequireDefault(_inside2);
...
var EdgeRing = function () {
  ...
  _createClass(EdgeRing, [{
    ...
    value: function isHole() {
      ...
      var hiIndex = this.edges.reduce(function (high, edge, i) {
        ...
        return high;
          ...
          disc = (0, _util.orientationIndex)(this.edges[iPrev].from.coordinates, this.edges[hiIndex].from.coordinates, this.edges[iNext].from.coordinates);
    ...
    value: function toMultiPoint() {
      return (0, _helpers.multiPoint)(this.edges.map(function (edge) {
    ...
    value: function toPolygon() {
      ...
      return this.polygon = (0, _helpers.polygon)([coordinates]);
    }
    ...
    value: function getEnvelope() {
      ...
      return this.envelope = (0, _envelope2.default)(this.toPolygon());
    }
    ...
    value: function inside(point) {
      return (0, _inside3.default)(point, this.toPolygon());
    }
  }, {
    key: 'length',
    get: function get() {
    ...
    value: function findEdgeRingContaining(testEdgeRing, shellList) {
      ...
      shellList.forEach(function (shell) {
        ...
        if ((0, _util.envelopeIsEqual)(tryEnvelope, testEnvelope)) return;

        if ((0, _util.envelopeContains)(tryEnvelope, testEnvelope)) {
          var testPoint = testEdgeRing.map(function (edge) {
            return edge.from.coordinates;
          }).find(function (pt) {
            return !shell.some(function (edge) {
              return (0, _util.coordinatesEqual)(pt, edge.from.coordinates);
            });
          });

          if (testPoint && shell.inside((0, _helpers.point)(testPoint))) {
            if (!minShell || (0, _util.envelopeContains)(minEnvelope, tryEnvelope)) minShell = shell;
          }
        }
      });
