let orientationIndex,envelopeIsEqual,envelopeContains,coordinatesEqual;_919‍.w('./util',[["orientationIndex",function(v){orientationIndex=v}],["envelopeIsEqual",function(v){envelopeIsEqual=v}],["envelopeContains",function(v){envelopeContains=v}],["coordinatesEqual",function(v){coordinatesEqual=v}]]);let multiPoint,polygon,point;_919‍.w('@turf/helpers',[["multiPoint",function(v){multiPoint=v}],["polygon",function(v){polygon=v}],["point",function(v){point=v}]]);let envelope;_919‍.w('@turf/envelope',[["default",function(v){envelope=v}]]);let _inside;_919‍.w('@turf/inside',[["default",function(v){_inside=v}]]);var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
