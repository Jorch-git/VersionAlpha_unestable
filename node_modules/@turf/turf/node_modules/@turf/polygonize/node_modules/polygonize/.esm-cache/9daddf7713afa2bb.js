let orientationIndex,envelopeIsEqual,envelopeContains,coordinatesEqual;_13a‍.w('./util',[["orientationIndex",function(v){orientationIndex=v}],["envelopeIsEqual",function(v){envelopeIsEqual=v}],["envelopeContains",function(v){envelopeContains=v}],["coordinatesEqual",function(v){coordinatesEqual=v}]]);let multiPoint,polygon,point;_13a‍.w('@turf/helpers',[["multiPoint",function(v){multiPoint=v}],["polygon",function(v){polygon=v}],["point",function(v){point=v}]]);let envelope;_13a‍.w('@turf/envelope',[["default",function(v){envelope=v}]]);let inside;_13a‍.w('@turf/inside',[["default",function(v){inside=v}]]);
