let Node;_cf6‍.w('./Node',[["default",function(v){Node=v}]]);let Edge;_cf6‍.w('./Edge',[["default",function(v){Edge=v}]]);let EdgeRing;_cf6‍.w('./EdgeRing',[["default",function(v){EdgeRing=v}]]);let flattenEach,coordReduce;_cf6‍.w('@turf/meta',[["flattenEach",function(v){flattenEach=v}],["coordReduce",function(v){coordReduce=v}]]);let featureOf;_cf6‍.w('@turf/invariant',[["featureOf",function(v){featureOf=v}]]);var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
