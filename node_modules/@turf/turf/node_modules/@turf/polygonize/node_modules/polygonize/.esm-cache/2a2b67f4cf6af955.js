let fs;_cf6‍.w('fs',[["default",function(v){fs=v}]]);let test;_cf6‍.w('tape',[["default",function(v){test=v}]]);let path;_cf6‍.w('path',[["default",function(v){path=v}]]);let load;_cf6‍.w('load-json-file',[["default",function(v){load=v}]]);let write;_cf6‍.w('write-json-file',[["default",function(v){write=v}]]);let featureEach;_cf6‍.w('@turf/meta',[["featureEach",function(v){featureEach=v}]]);let featureCollection,lineString,polygon,point;_cf6‍.w('@turf/helpers',[["featureCollection",function(v){featureCollection=v}],["lineString",function(v){lineString=v}],["polygon",function(v){polygon=v}],["point",function(v){point=v}]]);let polygonize;_cf6‍.w('./',[["default",function(v){polygonize=v}]]);
