...
function polygonize(geoJson) {
  var graph = _Graph2.default.fromGeoJson(geoJson);
  ...
  holes.forEach(function (hole) {
    if (_EdgeRing2.default.findEdgeRingContaining(hole, shells)) shells.push(hole);
  });

  // 5. EdgeRings to Polygons
  return (0, _helpers.featureCollection)(shells.map(function (shell) {
