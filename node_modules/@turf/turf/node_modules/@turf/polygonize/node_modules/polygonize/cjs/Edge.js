...
var Edge = function () {
  ...
  _createClass(Edge, [{
    ...
    value: function toLineString() {
      return (0, _helpers.lineString)([this.from.coordinates, this.to.coordinates]);
    }
    ...
    value: function compareTo(edge) {
      return (0, _util.orientationIndex)(edge.from.coordinates, edge.to.coordinates, this.to.coordinates);
    }
  }]);
