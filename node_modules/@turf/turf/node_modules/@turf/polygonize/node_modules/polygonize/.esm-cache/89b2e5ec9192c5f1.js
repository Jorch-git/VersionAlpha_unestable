let fs;_919‍.w('fs',[["default",function(v){fs=v}]]);let test;_919‍.w('tape',[["default",function(v){test=v}]]);let path;_919‍.w('path',[["default",function(v){path=v}]]);let load;_919‍.w('load-json-file',[["default",function(v){load=v}]]);let write;_919‍.w('write-json-file',[["default",function(v){write=v}]]);let featureEach;_919‍.w('@turf/meta',[["featureEach",function(v){featureEach=v}]]);let featureCollection,lineString,polygon,point;_919‍.w('@turf/helpers',[["featureCollection",function(v){featureCollection=v}],["lineString",function(v){lineString=v}],["polygon",function(v){polygon=v}],["point",function(v){point=v}]]);let polygonize;_919‍.w('./',[["default",function(v){polygonize=v}]]);
