...
exports.coordinatesEqual = exports.envelopeContains = exports.envelopeIsEqual = exports.orientationIndex = undefined;

var _inside = require('@turf/inside');
...
function envelopeContains(self, env) {
  return env.geometry.coordinates[0].every(function (c) {
    return (0, _inside2.default)((0, _helpers.point)(c), self);
  });
}
