...
function splitLineWithPoint(line, splitter) {
    ...
    if (pointsEquals(startPoint, invariant.getCoords(splitter)) ||
        pointsEquals(endPoint, invariant.getCoords(splitter))) return helpers.featureCollection([line]);
    ...
    var lastCoords = meta.featureReduce(segments, function (previous, current, index) {
        ...
        var splitterCoords = invariant.getCoords(splitter);
