...
IIUNAMacum=`cat /home/centos/scripts/Node/data2/IIUNAMacum.txt`
ARAGONacum=`cat /home/centos/scripts/Node/data2/ARAGONacum.txt`
COAPAacum=`cat /home/centos/scripts/Node/data2/COAPAacum.txt`
BOSQUEREALacum=`cat /home/centos/scripts/Node/data2/BOSQUEREALacum.txt`
DOSRIOSacum=`cat /home/centos/scripts/Node/data2/DOSRIOSacum.txt`
CUAJIMALPAacum=`cat /home/centos/scripts/Node/data2/CUAJIMALPAacum.txt`
MADINacum=`cat /home/centos/scripts/Node/data2/MADINacum.txt`
VHERMOSAacum=`cat /home/centos/scripts/Node/data2/VHERMOSAacum.txt`
PREPA4acum=`cat /home/centos/scripts/Node/data2/PREPA4acum.txt`
SACMEXacum=`cat /home/centos/scripts/Node/data2/SACMEXacum.txt`
TLALNEacum=`cat /home/centos/scripts/Node/data2/TLALNEacum.txt`
CCHOTEacum=`cat /home/centos/scripts/Node/data2/CCHOTEacum.txt`
CCHVALLEJOacum=`cat /home/centos/scripts/Node/data2/CCHVALLEJOacum.txt`

tmpIIUNAMacum=`cat /home/centos/scripts/Node/data2/tmpIIUNAMacum.txt`
tmpARAGONacum=`cat /home/centos/scripts/Node/data2/tmpARAGONacum.txt`
tmpCOAPAacum=`cat /home/centos/scripts/Node/data2/tmpCOAPAacum.txt`
tmpBOSQUEREALacum=`cat /home/centos/scripts/Node/data2/tmpBOSQUEREALacum.txt`
tmpDOSRIOSacum=`cat /home/centos/scripts/Node/data2/tmpDOSRIOSacum.txt`
tmpCUAJIMALPAacum=`cat /home/centos/scripts/Node/data2/tmpCUAJIMALPAacum.txt`
tmpMADINacum=`cat /home/centos/scripts/Node/data2/tmpMADINacum.txt`
tmpVHERMOSAacum=`cat /home/centos/scripts/Node/data2/tmpVHERMOSAacum.txt`
tmpPREPA4acum=`cat /home/centos/scripts/Node/data2/tmpPREPA4acum.txt`
tmpSACMEXacum=`cat /home/centos/scripts/Node/data2/tmpSACMEXacum.txt`
tmpTLALNEacum=`cat /home/centos/scripts/Node/data2/tmpTLALNEacum.txt`
tmpCCHOTEacum=`cat /home/centos/scripts/Node/data2/tmpCCHOTEacum.txt`
tmpCCHVALLEJOacum=`cat /home/centos/scripts/Node/data2/tmpCCHVALLEJOacum.txt`
                ...
                if [[ $file == *.oh  ]]; then
                    ...
                    do
                        ...
                        if [[ $compara == "02:" ]]; then
                                ...
                                NAcum=${estacion}${cumu2}
                                TmpAcum=${tmp}${estacion}${cumu2}
                                viejaAcum=`cat /home/centos/scripts/Node/data2/$NAcum`
                                temporalAcum=`cat /home/centos/scripts/Node/data2/$TmpAcum`

                                resta=`calc $temporalAcum - $acum2`

                                  algo=`echo $resta'>'$valorP | bc -l`
                                  echo $algo
                                  #if [[ "$algo" -eq 1 ]];then
                                  #   viejaAcum=`calc $viejaAcum + $acum2`
                                  #   viejaAcum > /home/centos/scripts/Node/data2/$NAcum
                                  #   acumuladamas=$viejaAcum
                                  #   temporalAcum=$acum2
                                  #   temporalAcum > /home/centos/scripts/Node/data2/$TmpAcum
                                  #   echo "es mayor"
                                  #else
                                  #   viejaAcum=`calc $viejaAcum - $acum2 -temporalAcum`
                                  #   acumuladamas=$viejaAcum
                                  #   viejaAcum > /home/centos/scripts/Node/data2/$NAcum
                                  #   temporalAcum=$acum2
                                  #   temporalAcum > /home/centos/scripts/Node/data2/$TmpAcum

                                  #echo "es menor que 0.1"
                                  #fi
...
INSERT INTO estaciones (estacion,fecha_servidor,fecha_estacion,intensidad,acumulada,acumuladaplus,visibi,gotas,volta,reflec,tipo,cinetica) VALUES ('$estacion', '$tiempoServidor', '$tiempoEstacion', '$inten2', '$acum2', '$acumuladamas', '$visi2', '$gotas2', '$voltaje2', '$reflec2', '$tipolluvia', '$cine2');
EOF
                    ...
                    while IFS= read -r line; do
                        ...
                        resta=`calc $temporalAcum - $acum`

                          algo=`echo $resta'>'$valorP | bc -l`
                          echo $algo
                          #if [[ "$algo" -eq 1 ]];then
                          #   viejaAcum=`calc $viejaAcum + $acum`
				          #      echo $viejaAcum
                          #      echo $NAcum
                          #   viejaAcum > /home/centos/scripts/Node/data2/$NAcum
                          #   acumuladamas=$viejaAcum
                          ...
                          #   echo "es mayor"
                          #else
                          #   viejaAcum=`calc $viejaAcum - $acum -temporalAcum`
                          #   acumuladamas=$viejaAcum
                          #   viejaAcum > /home/centos/scripts/Node/data2/$NAcum
                          #   temporalAcum=$acum
                          #   temporalAcum > /home/centos/scripts/Node/data2/$TmpAcum
                          ...
                          echo "ACumuldad mas "$acumuladamas
