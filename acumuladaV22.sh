...
"$catorce1" "$catorce2"" > $dir/datospagina.txt
        ...
        ./acum.sh
        sleep 1
        sudo scp -i /home/centos/scripts/Node/id_rsa /home/centos/scripts/Node/tests/compres/Acumatriz.txt.gz /home/centos/scripts/Node/data/datospagina.txt jorge@166.62.38.156:/home/jorge/public_html/geojson
